...
?>
<br>
<h2 class="data-sekolah">Data Artikel</h2>
...
<tr>
	...
	<td><a onclick="return confirm('Hapus Data <?php echo $key['judul'];?>')" href="proses/sekolah/hapus.php?id= <?php echo $key['id'];?>">Hapus</a></td> 
</tr>
<?php
	$i++;
}
